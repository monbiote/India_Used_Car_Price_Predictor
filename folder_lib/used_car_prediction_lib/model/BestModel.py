from .ModelCrossValidation import Lasso_Regression_ModelCrossValidator, Ridge_Regression_ModelCrossValidator, Gradient_Boosting_Regression_ModelCrossValidator
from .TrainModel import Linear_Regression_TrainModel
...
class BestModel:
    ...
    def best_model(X_train, y_train, X_test, y_test):
        lr = Linear_Regression_TrainModel()
        
        # Linear Regression
        linear_mse, linear_rmse,_, linear_r2, _ = lr.regression_process(X_train, y_train, X_test, y_test)
        ...
        lasso_cv_mse, lasso_cv_rmse, y_pred, lasso_cv_r2, best_alpha= larcv.regressing_process_cv(X_train, y_train, X_test, y_test)
        ...
        ridge_cv_mse, ridge_cv_rmse,y_pred, ridge_cv_r2, best_alpha = rircv.regressing_process_cv(X_train, y_train, X_test, y_test)
        ...
        gboost_cv_mse, gboost_cv_rmse, y_pred, gboost_cv_r2, best_params = gbrcv.regressing_process_cv(X_train, y_train, X_test, y_test)

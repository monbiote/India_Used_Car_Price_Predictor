class StringConvertor:
    ...
    def convert_engine(self,column):
        try:
    ...
    def convert_seats(self,seats_str):
        try:
    ...
    def keep_first_word(self,input_string):
...
class OwnershipConvertor:
    ...
    def extract_first_integer(self,ownership_str):
        try:
...
class PriceUnitConvertor:
    ...
    def convert_comma_to_dot(self,column):
        try:
